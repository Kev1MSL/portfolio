...
import FeaturedProject, {ProjectProps, ProjectType} from "../../components/Home/HighlightProjects/FeaturedProject";
    ...
    const projects: ProjectInfo[] = [
        ...
        },
        {
            ...
            info: {
                ...
                description:
                    "Developed a secure and efficient application to run on Intel SGX enclaves. It was my first glimpse on hardware security, and it is definitely a topic I would like to learn more.",
