...
export default function ExperiencesAndAchievements() {
	const experiences : ExperienceProps[] = [
		...
		},
		{
			...
			company: "Entreprendre Pour Apprendre PACA",
		...
		<div className={styles.contentContainer}>
			...
			<div className={styles.content}>
				<p className={styles.contentIntro}>
					...
					discovered that I am passionate about it. Also curious about networks and hardware security, I am now looking to develop
					my skills in this field through my studies and professional experiences.
				</p>
				...
				<span className={styles.moreInformationText}>More information on my <a className={styles.linkToLinkedIn} href={"https://www.linkedin.com/in/kevin-messali/details/experience/"} target={"_blank"}>LinkedIn profile.</a></span>
			</div>
		</div>
	);
}