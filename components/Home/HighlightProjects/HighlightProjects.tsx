        ...
        <div className={styles.contentContainer}>
            ...
            <div className={styles.content}>
                <p className={styles.contentDescription}>
                    Curious by nature, I love to explore new technologies and learn new skills. This comes from a
                    constant desire to improve myself and understand the world around me. I am always looking for new
                    challenges to overcome and new problems to solve. I have discovered programming during my last year
                    of primary school and since then I have been hooked. I have been working on plenty of projects in a
                    lot of different fields, ranging from mobile application, to IoT without forgetting blockchain and
                    machine learning. Because of my most recent projects, I am now focusing on web development and
                    machine learning.
                </p>
                <div className={styles.techStack}>
                    <h3 className={styles.technicalInfoTitle}>The most recent technologies I have worked with</h3>
                    <ul className={styles.techStackList}>
                        <li className={styles.techStackItem}>
                            <ArrowRightCircleIcon className={styles.techStackItemIcon} /> Next.js
                        </li>
                        <li className={styles.techStackItem}>
                ...
                <div className={styles.projects}>
                    <div className={styles.projectListContainer}>
                        <FeaturedProject
                            ...
                            description={"Portfolio & blog website fully built from scratch and powered with Next.js."}
                            image={"logo/logo.png"}
