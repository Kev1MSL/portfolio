        ...
        <Card className={styles.featuredProjectContainer}>
            <div className={styles.featuredProject}>
                ...
                <div className={styles.featuredProjectImageContainer}>
                    <img src={prop.image} alt={prop.title} className={styles.featuredProjectImage} />
                </div>
                <div className={styles.featuredProjectContent}>
                    <h4 className={styles.featuredProjectTitle}>{prop.title}</h4>
                    <p className={styles.featuredProjectDescription}>{prop.description}</p>
                    <div className={styles.techStackContainer}>
                        <ul className={styles.featuredProjectTechStack}>
                            {prop.techStack.map((tech, index) => {
                                return (
                                    <li key={index} className={styles.featuredProjectTechStackItem}>
                                        {tech}
                                    </li>
                                );
                            })}
                    ...
                    <div className={styles.featuredProjectLinks}>
                        {prop.links?.github && (
                            <a href={prop.links.github} className={styles.featuredProjectLink} target="_blank">
                        ...
                        {prop.links?.website && (
                            <a href={prop.links.website} className={styles.featuredProjectLink} target="_blank">
