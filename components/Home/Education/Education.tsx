...
export default function Education() {
	const highSchoolDetails: TimelineAdditionalDetailsProps = {
		grade: "18.6/20",
		activities: "Creation of our high-school's mini-company, European section, Aeronautical initiation certification",
		achievements: "Won the 1st place in the 2018 edition of the regional competition and 2nd place of the national competition of high-school mini-companies"
	};
		...
		<div className={styles.contentContainer}>
			...
			<div className={styles.content}>
				<p className={styles.contentIntro}>
					...
					the future, by empowering me with a strong problem solving and analytical mindset. It is actually only
					in my last year of bachelor that I understood the real meaning of learning mathematics. I thought that
					doing this much theory was useless and that there was almost no application in the real world. But I
					finally understood that we learn mathematics to learn how to think differently and out-of-the-box, which
					is what is needed to tackle the most challenging problems of our time.
				</p>
				<ul className={styles.timeline}>
					<li className={styles.timelineItem}>
						<TimelineItem date={"2020 - 2023"} location={"Palaiseau, France"} school={"Ecole Polytechnique (l'X)"}
						              degree={"Bachelor of Science — Majors Maths & Computer Science"} details={universityDetails}/>
					</li>
					<li className={styles.timelineItem}>
						<TimelineItem date={"Fall 2022"} location={"Seoul, Korea"} school={"Seoul National University"} degree={"Exchange student"} details={exchangeDetails}/>
					</li>
					<li className={styles.timelineItem}>
						<TimelineItem date={"2017 - 2020"} location={"Cannes, France"} school={"Lycée Jules Ferry"} degree={"Baccalauréat Scientifique — Option Engineering Science"} details={highSchoolDetails}/>
					</li>
				</ul>
			</div>
		</div>
