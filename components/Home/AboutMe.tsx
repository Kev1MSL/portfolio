				...
				<div className={styles.textContainer}>
					...
					<div className={styles.myMissionContainer}>
						<h3 className={styles.myMission}>
							My Mission: <span className={styles.missionKeyword}>Impact</span>{" "}
							and <span className={styles.missionKeyword}>Disrupt</span>
						</h3>
						<p className={styles.myMissionDescription}>
							I read somewhere that we should define ourselves as verbs rather
							than words. With verbs we allow ourselves to grow beyond who we
							are, making us both more creative and more open-minded. I believe
							that our generation is going to play a crucial role for the future
							of humankind as we have a lot of issues to overcome. For this
							reason, I am driven by constantly challenging the status quo and
							impacting positively the world around me.
						</p>
					</div>
				</div>
