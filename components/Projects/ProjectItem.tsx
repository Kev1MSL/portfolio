...
export default function ProjectItem(prop: ProjectProps) {
    let image;
    if (prop.image) {
        image = <img src={prop.image} alt={prop.title} className={styles.projectImage} />;
    } else {
            ...
            <div className={styles.project}>
                ...
                <div className={styles.projectContent}>
                    ...
                    <div className={styles.projectLinks}>
                        {prop.links.github && (
                            <a href={prop.links.github} className={styles.projectLink} target="_blank">
                        ...
                        {prop.links.website && (
                            <a href={prop.links.website} className={styles.projectLink} target="_blank">
